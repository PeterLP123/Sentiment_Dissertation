...
| Backward external-time arm | Frozen and collecting, without prices or returns | Same 33 companies, 2024-01-01 to 2025-10-26; up to 10,000 requests/day after the operational amendment, with future requests date-major so partial checkpoints converge toward a complete cross-section; `final_experiments/frozen_specs/lseg_gemma_finbert_hybrid_backward_v1.json` |
