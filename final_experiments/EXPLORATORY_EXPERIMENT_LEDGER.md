...
Last updated: 2026-07-31. This is the current completion ledger for the
...
| Learned trade/no-trade thresholds | Pooled arm complete; sector/stock variants blocked | Notebook 10 fits through 2017, selects on 2018–2019, and discloses 2020–2023 once. The fixed band, logistic, gradient-boosted, MLP, and shuffled-label MLP all have negative evaluation net Sharpe at 10 bps/side (−3.135, −3.699, −1.938, −1.827, −1.205). All learned-model evaluation AUCs are approximately 0.49–0.50. Cutoff selection requires at least five active names on average and activity on at least half of sessions, preventing a near-zero-trade artefact. A point-in-time FNSPID sector map is absent, so the protocol-required sector-first and subsequent stock-specific variants cannot be fit honestly. |
