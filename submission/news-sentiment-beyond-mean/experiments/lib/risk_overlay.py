...
from experiments.lib.evaluate import block_bootstrap_mean
...
def build_market_risk_exposure(
    ...
    *,
    ...
    the historically standardised z-score exists, exposure is one.  The current
    mapped session enters the z-score numerator; only its normalisation baseline
    is lagged.  Both rules are long-or-cash and never exceed baseline exposure.
    """
