...
def test_libsql_connection_from_env_uses_embedded_replica(monkeypatch: pytest.MonkeyPatch, tmp_path) -> None:
    ...
    assert calls["connect"] == (
        ...
        {"sync_url": "libsql://example.turso.io", "auth_token": "token"},
    )
